...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private HashMap<Coordinates, SudokuTextField> textFiledCoordinates;
    ...
    private static final String SUDOKU = "SudokuCookie";

    public UserInterfaceImpl(Stage stage) {
        this.stage = stage;
        this.root = new Group();
        this.textFiledCoordinates = new HashMap<>();
    ...
    private void drawTextFields(Group root) {
        ...
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                ...
                textFiledCoordinates.put(new Coordinates(xIndex, yIndex), tile);
    ...
    public void updateSquare(int x, int y, int input) {
        SudokuTextField tile = textFiledCoordinates.get(new Coordinates(x, y));
    ...
    public void updateBoard(SudokuGame game) {
        for (int xIndex = 0; xIndex < 9; xIndex++) {
            for (int yIndex = 0; yIndex < 9; yIndex++) {
                TextField tile = textFiledCoordinates.get((new Coordinates(xIndex, yIndex)));
